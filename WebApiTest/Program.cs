...
builder.Services.AddAuthentication(CookieAuthenticationDefaults.AuthenticationScheme)
    ...
    {
        options.LoginPath = "/Home/Check11";
        options.AccessDeniedPath = "/Home/Check12";
    })
    .AddCookie("CookieAuth", config =>
    {
        config.LoginPath = "/Home/Check21";//默认 /Acount/Login
        config.AccessDeniedPath = "/Home/Check22";
    });
